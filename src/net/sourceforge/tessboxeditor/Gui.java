...
public class Gui extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabelSubimage = new SubImageView();//javax.swing.JLabel();
        ...
        JPanel jPanelControlsInner = new JPanel();
        jPanelControlsInner.setLayout(new java.awt.BorderLayout());
        jPanelControlsInner.setBackground(java.awt.Color.lightGray);
        ...
        //jPanelControls.setLayout(new java.awt.FlowLayout(FlowLayout.TRAILING));

        JPanel marginsWithLabel = new JPanel();
        marginsWithLabel.setBackground(java.awt.Color.lightGray);
        marginsWithLabel.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEFT));

        JLabel marginsLabel = new JLabel();
        marginsLabel.setText("Margins:");
        marginsWithLabel.add(marginsLabel);

        final JSpinner jSpinnerMargin = new javax.swing.JSpinner();
        jSpinnerMargin.setValue(ICON_MARGIN_PIXELS);
        jSpinnerMargin.addChangeListener(new ChangeListener() {
            @Override
            public void stateChanged(ChangeEvent e) {
                ICON_MARGIN_PIXELS = (Integer) jSpinnerMargin.getValue();
                int index = jTable.getSelectedRow();
                jTable.clearSelection();
                jTable.setRowSelectionInterval(index, index);
            }
        });
        marginsWithLabel.add(jSpinnerMargin);

        jPanelControlsInner.add(marginsWithLabel, BorderLayout.NORTH);

        JPanel scaleWithLabel = new JPanel();
        scaleWithLabel.setBackground(java.awt.Color.lightGray);
        scaleWithLabel.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEFT));

        JLabel scaleLabel = new JLabel();
        scaleLabel.setText("Scale:");
        scaleWithLabel.add(scaleLabel);

        final JSpinner jSpinnerScale = new javax.swing.JSpinner();
        jSpinnerScale.setValue(scaleFactor);
        jSpinnerScale.addChangeListener(new ChangeListener() {
            @Override
            public void stateChanged(ChangeEvent e) {
        ...
        scaleWithLabel.add(jSpinnerScale);
        jPanelControlsInner.add(scaleWithLabel, BorderLayout.SOUTH);

        jPanelControls.add(jPanelControlsInner, BorderLayout.NORTH);

        final JCheckBox jCheckboxInvertControls = new JCheckBox();
        jCheckboxInvertControls.setText("invert controls");
        jCheckboxInvertControls.addChangeListener(new ChangeListener() {
            @Override
            public void stateChanged(ChangeEvent e) {
                invertControls = jCheckboxInvertControls.isSelected();
            }
        });
        jPanelControls.add(jCheckboxInvertControls, BorderLayout.SOUTH);

        JPanel jPanelNorthContainer = new JPanel();
        jPanelNorthContainer.setBackground(java.awt.Color.lightGray);
        jPanelNorthContainer.setLayout(new java.awt.BorderLayout());

        jPanelNorthContainer.add(jPanel1, BorderLayout.NORTH);
        jPanelNorthContainer.add(jPanelControls, BorderLayout.SOUTH);
